          ...
          <div class="card construction-card">
              <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group mb-3">
                            <label>Batch</label>
                            <input type="number" name="batch" class="form-control" placeholder="Enter batch year">
                        </div>

                        <div class="form-group mb-3">
                            <label>Age</label>
                            <input type="number" name="age" class="form-control" placeholder="Enter age" style = "width: 150px;">
                        </div>
