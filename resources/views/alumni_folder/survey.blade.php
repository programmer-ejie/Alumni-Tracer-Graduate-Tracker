        ...
        <!-- [ sample-page ] start -->
          <div class="card construction-card">
              <div class="card-body">
               ...
               <form id="surveyForm" method="POST" action="{{ route('alumni.survey.submit') }}">
                @csrf
                    {{-- number 1 --}}
                        <div class="mb-3">
                            <label class="form-label fw-bold">1. Current employment status:</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="employmentStatus" id="employed" value="Employed"
                    ...
                    {{-- number 2 --}}
                       <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jobTitle" id="softwareDeveloper" value="Software Developer"
                            ...
                            <input type="text" id="otherJobInput" name="jobTitleOther" placeholder="Please specify"
                                class="form-control"
              ...
              {{-- number 3 --}}
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="industry" id="itSoftware" value="IT and Software Development"
                            ...
                            <input type="text" id="otherIndustryInput" name="industryOther" placeholder="Please specify"
                                class="form-control"
                      ...
                      {{-- number 4 --}}
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jobDuration" id="less1" value="Less than 1 year"
                        ...
                        {{-- number 5 --}}
                          @php
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerChange" id="careerNo" value="No"
                                ...
                                <div class="form-group mt-2" id="careerReasonGroup" style="display: {{ $isYes || $isCustom ? 'block' : 'none' }};">
                                    ...
                                    <input type="text" class="form-control" id="careerReason" name="careerReason"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="satisfaction" id="verySatisfied" value="Very Satisfied"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="workforcePrep" name="workforcePrep" required>
                                <option value="" disabled {{ !isset($survey) || !$survey->q7 ? 'selected' : '' }}>Select a rating</option>
                                @for($i=1; $i<=10; $i++)
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="beneficialSkill" id="skillProgramming" value="Programming languages"
                            ...
                            <input type="text" class="form-control mt-2" id="skillOtherInput" name="skillOtherInput" placeholder="Please specify other skill"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="handsOnExperience" id="handsOnYes" value="Yes, internships and practical projects were helpful"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="handsOnExperience" id="handsOnOther" value="Other"
                            ...
                            <input type="text" class="form-control mt-2" id="handsOnOtherInput" name="handsOnOtherInput" placeholder="Please specify"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="facultySupport" id="facultyVerySatisfied" value="Very Satisfied"
                    ...
                    {{-- number 11 --}}
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparedness" id="preparedYes" value="Yes" {{ $isPreparedYes ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="preparedYes">Yes</label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparedness" id="preparedNo" value="No" {{ $isPreparedNo ? 'checked' : '' }}>
                                ...
                                <div class="form-group mt-2" id="improvementAreaGroup" style="display: {{ $isPreparedNo ? 'block' : 'none' }};">
                                    ...
                                    <input type="text" class="form-control" id="improvementArea" name="improvementArea" placeholder="Enter specific areas" value="{{ $improvementText }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="resourceRating" id="resourceExcellent" value="Excellent" @if(isset($survey) && $survey->q12 == 'Excellent') checked @endif required>
                                    <label class="form-check-label" for="resourceExcellent">Excellent – All resources were readily available</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="resourceRating" id="resourceGood" value="Good" @if(isset($survey) && $survey->q12 == 'Good') checked @endif>
                                    <label class="form-check-label" for="resourceGood">Good – Some resources were available, but limited during peak times</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="resourceRating" id="resourceFair" value="Fair" @if(isset($survey) && $survey->q12 == 'Fair') checked @endif>
                                    <label class="form-check-label" for="resourceFair">Fair – Often had to wait or search for available equipment</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="resourceRating" id="resourcePoor" value="Poor" @if(isset($survey) && $survey->q12 == 'Poor') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobSearchDuration" id="less3months" value="Less than 3 months" @if(isset($survey) && $survey->q13 == 'Less than 3 months') checked @endif required>
                                    <label class="form-check-label" for="less3months">Less than 3 months</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobSearchDuration" id="3to6months" value="3-6 months" @if(isset($survey) && $survey->q13 == '3-6 months') checked @endif>
                                    <label class="form-check-label" for="3to6months">3-6 months</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobSearchDuration" id="6to12months" value="6-12 months" @if(isset($survey) && $survey->q13 == '6-12 months') checked @endif>
                                    <label class="form-check-label" for="6to12months">6-12 months</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobSearchDuration" id="more12months" value="More than 12 months" @if(isset($survey) && $survey->q13 == 'More than 12 months') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobChallenges" id="lackExperience" value="Lack of work experience (overcame by internships)" @if(isset($survey) && $survey->q14 == 'Lack of work experience (overcame by internships)') checked @endif required>
                                    <label class="form-check-label" for="lackExperience">Lack of work experience (overcame by internships)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobChallenges" id="limitedOpportunities" value="Limited job opportunities in the region (explored remote positions)" @if(isset($survey) && $survey->q14 == 'Limited job opportunities in the region (explored remote positions)') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobChallenges" id="highCompetition" value="High competition in the job market (attended networking events)" @if(isset($survey) && $survey->q14 == 'High competition in the job market (attended networking events)') checked @endif>
                                    <label class="form-check-label" for="highCompetition">High competition in the job market (attended networking events)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobChallenges" id="unclearExpectations" value="Unclear job market expectations (sought career guidance)" @if(isset($survey) && $survey->q14 == 'Unclear job market expectations (sought career guidance)') checked @endif>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="relatedPosition" id="relatedYes" value="Yes"
                                    ...
                                    <div class="form-group mt-2" id="differentFieldGroup" style="display: {{ $isNo || $isCustom ? 'block' : 'none' }};">
                                        ...
                                        <input type="text" class="form-control" id="differentFieldReason" name="differentFieldReason"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobConfidence" id="confVery" value="Very Confident" @if(isset($survey) && $survey->q16 == 'Very Confident') checked @endif required>
                                    <label class="form-check-label" for="confVery">Very Confident</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobConfidence" id="confConfident" value="Confident" @if(isset($survey) && $survey->q16 == 'Confident') checked @endif>
                                    <label class="form-check-label" for="confConfident">Confident</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobConfidence" id="confNeutral" value="Neutral" @if(isset($survey) && $survey->q16 == 'Neutral') checked @endif>
                                    <label class="form-check-label" for="confNeutral">Neutral</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobConfidence" id="confUnconfident" value="Unconfident" @if(isset($survey) && $survey->q16 == 'Unconfident') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeAdvantage" id="advProgramming" value="Strong programming and technical skills" @if(isset($survey) && $survey->q17 == 'Strong programming and technical skills') checked @endif required>
                                    <label class="form-check-label" for="advProgramming">Strong programming and technical skills</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeAdvantage" id="advSDLC" value="Good understanding of software development lifecycle" @if(isset($survey) && $survey->q17 == 'Good understanding of software development lifecycle') checked @endif>
                                    <label class="form-check-label" for="advSDLC">Good understanding of software development lifecycle</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeAdvantage" id="advTools" value="Familiarity with industry-standard tools and platforms" @if(isset($survey) && $survey->q17 == 'Familiarity with industry-standard tools and platforms') checked @endif>
                                    <label class="form-check-label" for="advTools">Familiarity with industry-standard tools and platforms</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeAdvantage" id="advInternship" value="Internship experience with industry exposure" @if(isset($survey) && $survey->q17 == 'Internship experience with industry exposure') checked @endif>
                                    <label class="form-check-label" for="advInternship">Internship experience with industry exposure</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeAdvantage" id="advOther" value="Other" @if(isset($survey) && !in_array($survey->q17, [
                                ...
                                <div class="form-group mt-2" id="otherAdvInputGroup" style="display:{{ isset($survey) && !in_array($survey->q17, [
                                    ...
                                    <input type="text" class="form-control" id="otherAdvInput" name="otherDegreeAdvantage" placeholder="Please specify" value="{{ isset($survey) && !in_array($survey->q17, [
                                        'Strong programming and technical skills',
                                        'Good understanding of software development lifecycle',
                                        'Familiarity with industry-standard tools and platforms',
                                        'Internship experience with industry exposure'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="extracurricularGrowth" id="orgMembership" value="Membership in IT-related organizations" @if(isset($survey) && $survey->q18 == 'Membership in IT-related organizations') checked @endif required>
                                    <label class="form-check-label" for="orgMembership">Membership in IT-related organizations</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="extracurricularGrowth" id="competitions" value="Participation in programming or tech competitions" @if(isset($survey) && $survey->q18 == 'Participation in programming or tech competitions') checked @endif>
                                    <label class="form-check-label" for="competitions">Participation in programming or tech competitions</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="extracurricularGrowth" id="volunteering" value="Volunteering or community outreach projects" @if(isset($survey) && $survey->q18 == 'Volunteering or community outreach projects') checked @endif>
                                    <label class="form-check-label" for="volunteering">Volunteering or community outreach projects</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="extracurricularGrowth" id="studentLeadership" value="Student leadership roles (e.g., student council)" @if(isset($survey) && $survey->q18 == 'Student leadership roles (e.g., student council)') checked @endif>
                                    <label class="form-check-label" for="studentLeadership">Student leadership roles (e.g., student council)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="extracurricularGrowth" id="extracurricularOther" value="Other" @if(isset($survey) && !in_array($survey->q18, [
                                ...
                                <div class="form-group mt-2" id="otherExtracurricularGroup" style="display:{{ isset($survey) && !in_array($survey->q18, [
                                    ...
                                    <input type="text" class="form-control" id="otherExtracurricularInput" name="extracurricularGrowthOther" placeholder="Please specify" value="{{ isset($survey) && !in_array($survey->q18, [
                                        'Membership in IT-related organizations',
                                        'Participation in programming or tech competitions',
                                        'Volunteering or community outreach projects',
                                        'Student leadership roles (e.g., student council)'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobMarketOpinion" id="marketImproved" value="Improved – More job opportunities and higher demand for IT professionals" @if(isset($survey) && $survey->q19 == 'Improved – More job opportunities and higher demand for IT professionals') checked @endif required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobMarketOpinion" id="marketStable" value="Stable – Job market has remained the same" @if(isset($survey) && $survey->q19 == 'Stable – Job market has remained the same') checked @endif>
                                    <label class="form-check-label" for="marketStable">Stable – Job market has remained the same</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobMarketOpinion" id="marketDeclined" value="Declined – Limited job openings in the tech industry" @if(isset($survey) && $survey->q19 == 'Declined – Limited job openings in the tech industry') checked @endif>
                                    <label class="form-check-label" for="marketDeclined">Declined – Limited job openings in the tech industry</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jobMarketOpinion" id="marketUnchanged" value="Unchanged – No significant change in the job market" @if(isset($survey) && $survey->q19 == 'Unchanged – No significant change in the job market') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerSupport" id="careerSupportYes" value="Yes, the services were helpful" @if(isset($survey) && $survey->q20 == 'Yes, the services were helpful') checked @endif required>
                                    <label class="form-check-label" for="careerSupportYes">Yes, the services were helpful</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerSupport" id="careerSupportNo" value="No, the services were lacking" @if(isset($survey) && $survey->q20 == 'No, the services were lacking') checked @endif>
                                    <label class="form-check-label" for="careerSupportNo">No, the services were lacking</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerSupport" id="careerSupportSomewhat" value="Somewhat, but more guidance is needed" @if(isset($survey) && $survey->q20 == 'Somewhat, but more guidance is needed') checked @endif>
                    ...
                    {{-- number 21 --}}
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerAdvancementSupport" id="supportExcellent" value="Excellent – Regular mentorship and career development opportunities" @if(isset($survey) && $survey->q21 == 'Excellent – Regular mentorship and career development opportunities') checked @endif required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerAdvancementSupport" id="supportGood" value="Good – Occasional support, but more could have been offered." @if(isset($survey) && $survey->q21 == 'Good – Occasional support, but more could have been offered.') checked @endif>
                                    <label class="form-check-label" for="supportGood">Good – Occasional support, but more could have been offered.</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerAdvancementSupport" id="supportAverage" value="Average – Limited support for career growth" @if(isset($survey) && $survey->q21 == 'Average – Limited support for career growth') checked @endif>
                                    <label class="form-check-label" for="supportAverage">Average – Limited support for career growth</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerAdvancementSupport" id="supportPoor" value="Poor – No support for career advancement" @if(isset($survey) && $survey->q21 == 'Poor – No support for career advancement') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="professionalDevelopmentFrequency" id="devRegularly" value="Regularly (every 6 months or less)" @if(isset($survey) && $survey->q22 == 'Regularly (every 6 months or less)') checked @endif required>
                                    <label class="form-check-label" for="devRegularly">Regularly (every 6 months or less)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="professionalDevelopmentFrequency" id="devOccasionally" value="Occasionally (once a year)" @if(isset($survey) && $survey->q22 == 'Occasionally (once a year)') checked @endif>
                                    <label class="form-check-label" for="devOccasionally">Occasionally (once a year)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="professionalDevelopmentFrequency" id="devRarely" value="Rarely (once every few years)" @if(isset($survey) && $survey->q22 == 'Rarely (once every few years)') checked @endif>
                                    <label class="form-check-label" for="devRarely">Rarely (once every few years)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="professionalDevelopmentFrequency" id="devNever" value="Never" @if(isset($survey) && $survey->q22 == 'Never') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerChangeEvolution" id="leadershipRole" value="Leadership Roles" @if(isset($survey) && $survey->q23 == 'Leadership Roles') checked @endif required>
                                    <label class="form-check-label" for="leadershipRole">Yes, I have taken on more leadership roles</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerChangeEvolution" id="managementRole" value="Moved to Management" @if(isset($survey) && $survey->q23 == 'Moved to Management') checked @endif>
                                    <label class="form-check-label" for="managementRole">Yes, I moved from technical work to management.</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerChangeEvolution" id="complexProjects" value="More Complex Projects" @if(isset($survey) && $survey->q23 == 'More Complex Projects') checked @endif>
                                    <label class="form-check-label" for="complexProjects">Yes, I’ve had opportunities to work on more complex projects</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="careerChangeEvolution" id="roleSame" value="Role Remained Same" @if(isset($survey) && $survey->q23 == 'Role Remained Same') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="startingSalary" id="salary1" value="Below 10,000" @if(isset($survey) && $survey->q24 == 'Below 10,000') checked @endif required>
                                    <label class="form-check-label" for="salary1">Below ₱10,000</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="startingSalary" id="salary2" value="10,000-19,999" @if(isset($survey) && $survey->q24 == '10,000-19,999') checked @endif>
                                    <label class="form-check-label" for="salary2">₱10,000 - ₱19,999</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="startingSalary" id="salary3" value="20,000-29,999" @if(isset($survey) && $survey->q24 == '20,000-29,999') checked @endif>
                                    <label class="form-check-label" for="salary3">₱20,000 - ₱29,999</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="startingSalary" id="salary4" value="30,000-39,999" @if(isset($survey) && $survey->q24 == '30,000-39,999') checked @endif>
                                    <label class="form-check-label" for="salary4">₱30,000 - ₱39,999</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="startingSalary" id="salary5" value="40,000 and above" @if(isset($survey) && $survey->q24 == '40,000 and above') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="salarySatisfaction" id="salarySatYes" value="Yes"
                                        {{ $isYes ? 'checked' : '' }} required>
                                ...
                                <div class="form-group mt-2" id="salaryChangesGroup" style="display: {{ $isNo ? 'block' : 'none' }};">
                                    ...
                                    <input type="text" class="form-control" id="salaryChanges" name="salaryChanges"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeEarningPotential" id="earning1" value="Yes, the degree gave me foundational knowledge and credibility in the job market" @if(isset($survey) && $survey->q26 == 'Yes, the degree gave me foundational knowledge and credibility in the job market') checked @endif required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeEarningPotential" id="earning2" value="Yes, but more hands-on experience would have been beneficial" @if(isset($survey) && $survey->q26 == 'Yes, but more hands-on experience would have been beneficial') checked @endif>
                                    <label class="form-check-label" for="earning2">Yes, but more hands-on experience would have been beneficial</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeEarningPotential" id="earning3" value="No, the job market values skills and experience more than academic credentials" @if(isset($survey) && $survey->q26 == 'No, the job market values skills and experience more than academic credentials') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="degreeEarningPotential" id="earning4" value="No, I had to acquire additional certifications to improve my earning potential" @if(isset($survey) && $survey->q26 == 'No, I had to acquire additional certifications to improve my earning potential') checked @endif>
                            ...
                            {{-- number 27 --}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="alumniInvolvement" id="alumniNo" value="No" {{ $isAlumniNo ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="alumniNo">No</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="alumniInvolvement" id="alumniYes" value="Yes" {{ $isAlumniYes ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mt-2" id="alumniValueGroup" style="display: {{ $isAlumniYes ? 'block' : 'none' }};">
                                        ...
                                        <select class="form-select" id="alumniValue" name="alumniValue">
                                            <option value="" disabled {{ $selectedValue === '' ? 'selected' : '' }}>Select value</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="willingToMentor" id="mentorYes" value="Yes" @if(isset($survey) && $survey->q28 == 'Yes') checked @endif required>
                                    <label class="form-check-label" for="mentorYes">Yes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="willingToMentor" id="mentorNo" value="No" @if(isset($survey) && $survey->q28 == 'No') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEngagement" id="engageNetworking" value="Regular alumni networking events" @if(isset($survey) && $survey->q29 == 'Regular alumni networking events') checked @endif required>
                                    <label class="form-check-label" for="engageNetworking">Regular alumni networking events</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEngagement" id="engageMentorship" value="More alumni mentorship programs" @if(isset($survey) && $survey->q29 == 'More alumni mentorship programs') checked @endif>
                                    <label class="form-check-label" for="engageMentorship">More alumni mentorship programs</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEngagement" id="engagePlatform" value="A platform for alumni to share career advice and job opportunities" @if(isset($survey) && $survey->q29 == 'A platform for alumni to share career advice and job opportunities') checked @endif>
                                    <label class="form-check-label" for="engagePlatform">A platform for alumni to share career advice and job opportunities</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEngagement" id="engageProjects" value="Collaborative projects between alumni and students" @if(isset($survey) && $survey->q29 == 'Collaborative projects between alumni and students') checked @endif>
                                    <label class="form-check-label" for="engageProjects">Collaborative projects between alumni and students</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEngagement" id="engageOther" value="Other" @if(isset($survey) && !in_array($survey->q29, [
                                ...
                                <div class="mt-2" id="otherAlumniEngagementGroup" style="display:{{ isset($survey) && !in_array($survey->q29, [
                                    ...
                                    <input type="text" class="form-control" id="otherAlumniEngagementInput" name="otherAlumniEngagementInput" placeholder="Please specify" value="{{ isset($survey) && !in_array($survey->q29, [
                                        'Regular alumni networking events',
                                        'More alumni mentorship programs',
                                        'A platform for alumni to share career advice and job opportunities',
                                        'Collaborative projects between alumni and students'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniSupport" id="resource1" value="Access to professional development resources and courses" @if(isset($survey) && $survey->q30 == 'Access to professional development resources and courses') checked @endif required>
                                    <label class="form-check-label" for="resource1">Access to professional development resources and courses</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniSupport" id="resource2" value="Alumni-only networking events" @if(isset($survey) && $survey->q30 == 'Alumni-only networking events') checked @endif>
                                    <label class="form-check-label" for="resource2">Alumni-only networking events</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniSupport" id="resource3" value="Job boards or career counseling specifically for alumni" @if(isset($survey) && $survey->q30 == 'Job boards or career counseling specifically for alumni') checked @endif>
                                    <label class="form-check-label" for="resource3">Job boards or career counseling specifically for alumni</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniSupport" id="resource4" value="Opportunities to contribute to the university through mentoring or guest lectures" @if(isset($survey) && $survey->q30 == 'Opportunities to contribute to the university through mentoring or guest lectures') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniSupport" id="resourceOther" value="Other" @if(isset($survey) && !in_array($survey->q30, [
                                ...
                                <div class="form-group mt-2" id="otherAlumniSupportGroup" style="display:{{ isset($survey) && !in_array($survey->q30, [
                                    ...
                                    <input type="text" class="form-control" id="otherAlumniSupport" name="otherAlumniSupport" placeholder="Please specify" value="{{ isset($survey) && !in_array($survey->q30, [
                                        'Access to professional development resources and courses',
                                        'Alumni-only networking events',
                                        'Job boards or career counseling specifically for alumni',
                                        'Opportunities to contribute to the university through mentoring or guest lectures'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniCommunity" id="community1" value="Organize annual alumni reunions and events" @if(isset($survey) && $survey->q31 == 'Organize annual alumni reunions and events') checked @endif required>
                                    <label class="form-check-label" for="community1">Organize annual alumni reunions and events</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniCommunity" id="community2" value="Provide platforms for alumni to share their stories and successes" @if(isset($survey) && $survey->q31 == 'Provide platforms for alumni to share their stories and successes') checked @endif>
                                    <label class="form-check-label" for="community2">Provide platforms for alumni to share their stories and successes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniCommunity" id="community3" value="Create an online alumni portal for ongoing communication and support" @if(isset($survey) && $survey->q31 == 'Create an online alumni portal for ongoing communication and support') checked @endif>
                                    <label class="form-check-label" for="community3">Create an online alumni portal for ongoing communication and support</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniCommunity" id="community4" value="Engage alumni in university decision-making processes" @if(isset($survey) && $survey->q31 == 'Engage alumni in university decision-making processes') checked @endif>
                                    <label class="form-check-label" for="community4">Engage alumni in university decision-making processes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniCommunity" id="communityOther" value="Other" @if(isset($survey) && !in_array($survey->q31, [
                                ...
                                <div class="form-group mt-2" id="otherAlumniCommunityGroup" style="display:{{ isset($survey) && !in_array($survey->q31, [
                                    ...
                                    <input type="text" class="form-control" id="otherAlumniCommunity" name="otherAlumniCommunity" placeholder="Please specify" value="{{ isset($survey) && !in_array($survey->q31, [
                                        'Organize annual alumni reunions and events',
                                        'Provide platforms for alumni to share their stories and successes',
                                        'Create an online alumni portal for ongoing communication and support',
                                        'Engage alumni in university decision-making processes'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="contributeSupport" id="contributeYes" value="Yes" @if(isset($survey) && $survey->q32 == 'Yes') checked @endif required>
                                    <label class="form-check-label" for="contributeYes">Yes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="contributeSupport" id="contributeNo" value="No" @if(isset($survey) && $survey->q32 == 'No') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="futureParticipation" id="veryLikely" value="Very Likely" @if(isset($survey) && $survey->q33 == 'Very Likely') checked @endif required>
                                    <label class="form-check-label" for="veryLikely">Very Likely</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="futureParticipation" id="likely" value="Likely" @if(isset($survey) && $survey->q33 == 'Likely') checked @endif>
                                    <label class="form-check-label" for="likely">Likely</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="futureParticipation" id="neutral" value="Neutral" @if(isset($survey) && $survey->q33 == 'Neutral') checked @endif>
                                    <label class="form-check-label" for="neutral">Neutral</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="futureParticipation" id="unlikely" value="Unlikely" @if(isset($survey) && $survey->q33 == 'Unlikely') checked @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEvents" id="careerWorkshops" value="Career development workshops and webinars" @if(isset($survey) && $survey->q34 == 'Career development workshops and webinars') checked @endif required>
                                    <label class="form-check-label" for="careerWorkshops">Career development workshops and webinars</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEvents" id="mentorshipPrograms" value="Alumni mentorship programs for current students" @if(isset($survey) && $survey->q34 == 'Alumni mentorship programs for current students') checked @endif>
                                    <label class="form-check-label" for="mentorshipPrograms">Alumni mentorship programs for current students</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEvents" id="networkingEvents" value="Networking events in major cities" @if(isset($survey) && $survey->q34 == 'Networking events in major cities') checked @endif>
                                    <label class="form-check-label" for="networkingEvents">Networking events in major cities</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniEvents" id="guestLectures" value="Guest lectures and workshops by successful alumni" @if(isset($survey) && $survey->q34 == 'Guest lectures and workshops by successful alumni') checked @endif>
                                    <label class="form-check-label" for="guestLectures">Guest lectures and workshops by successful alumni</label>
                                </div>
                                <div class="form-check mt-2">
                                    <input class="form-check-input" type="radio" name="alumniEvents" id="otherEvent" value="Other" @if(isset($survey) && !in_array($survey->q34, [
                                ...
                                <input type="text" class="form-control mt-1" id="otherEventText" name="otherEventText" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q34, [
                                    'Career development workshops and webinars',
                                    'Alumni mentorship programs for current students',
                                    'Networking events in major cities',
                                    'Guest lectures and workshops by successful alumni'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniTies" id="alumniOffice" value="Establish a dedicated alumni office or team" @if(isset($survey) && $survey->q35 == 'Establish a dedicated alumni office or team') checked @endif required>
                                    <label class="form-check-label" for="alumniOffice">Establish a dedicated alumni office or team</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniTies" id="giveBackOpportunities" value="Provide more opportunities for alumni to give back (e.g., guest lectures, mentoring)" @if(isset($survey) && $survey->q35 == 'Provide more opportunities for alumni to give back (e.g., guest lectures, mentoring)') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniTies" id="newsletter" value="Create an alumni newsletter or digital publication" @if(isset($survey) && $survey->q35 == 'Create an alumni newsletter or digital publication') checked @endif>
                                    <label class="form-check-label" for="newsletter">Create an alumni newsletter or digital publication</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniTies" id="socialMediaCommunity" value="Foster an alumni community through social media and online platforms" @if(isset($survey) && $survey->q35 == 'Foster an alumni community through social media and online platforms') checked @endif>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" type="radio" name="alumniTies" id="otherTies" value="Other" @if(isset($survey) && !in_array($survey->q35, [
                                ...
                                <input type="text" class="form-control mt-1" id="otherTiesText" name="otherTiesText" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q35, [
                                    'Establish a dedicated alumni office or team',
                                    'Provide more opportunities for alumni to give back (e.g., guest lectures, mentoring)',
                                    'Create an alumni newsletter or digital publication',
                                    'Foster an alumni community through social media and online platforms'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitImprovements" id="handsOnLabs" value="Incorporate more hands-on labs and practical exercises" @if(isset($survey) && $survey->q36 == 'Incorporate more hands-on labs and practical exercises') checked @endif required>
                                    <label class="form-check-label" for="handsOnLabs">Incorporate more hands-on labs and practical exercises</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitImprovements" id="modernTech" value="Integrate more courses on modern technologies (e.g., AI, Data Science)" @if(isset($survey) && $survey->q36 == 'Integrate more courses on modern technologies (e.g., AI, Data Science)') checked @endif>
                                    <label class="form-check-label" for="modernTech">Integrate more courses on modern technologies (e.g., AI, Data Science)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitImprovements" id="industryExposure" value="Increase exposure to industry practices and software tools" @if(isset($survey) && $survey->q36 == 'Increase exposure to industry practices and software tools') checked @endif>
                                    <label class="form-check-label" for="industryExposure">Increase exposure to industry practices and software tools</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitImprovements" id="softSkills" value="Focus more on communication and soft skills development" @if(isset($survey) && $survey->q36 == 'Focus more on communication and soft skills development') checked @endif>
                                    <label class="form-check-label" for="softSkills">Focus more on communication and soft skills development</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitImprovements" id="otherImprovement" value="Other" @if(isset($survey) && !in_array($survey->q36, [
                                ...
                                <input type="text" id="otherImprovementInput" name="bsitImprovementsOther" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q36, [
                                    'Incorporate more hands-on labs and practical exercises',
                                    'Integrate more courses on modern technologies (e.g., AI, Data Science)',
                                    'Increase exposure to industry practices and software tools',
                                    'Focus more on communication and soft skills development'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitAdvice" id="beProactive" value="Be proactive in seeking internships and real-world experience" @if(isset($survey) && $survey->q37 == 'Be proactive in seeking internships and real-world experience') checked @endif required>
                                    <label class="form-check-label" for="beProactive">Be proactive in seeking internships and real-world experience</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitAdvice" id="buildNetwork" value="Build a strong network with professors and industry professionals" @if(isset($survey) && $survey->q37 == 'Build a strong network with professors and industry professionals') checked @endif>
                                    <label class="form-check-label" for="buildNetwork">Build a strong network with professors and industry professionals</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitAdvice" id="stayUpdated" value="Stay updated with the latest industry trends and technologies" @if(isset($survey) && $survey->q37 == 'Stay updated with the latest industry trends and technologies') checked @endif>
                                    <label class="form-check-label" for="stayUpdated">Stay updated with the latest industry trends and technologies</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitAdvice" id="focusSkills" value="Focus on developing both technical and soft skills" @if(isset($survey) && $survey->q37 == 'Focus on developing both technical and soft skills') checked @endif>
                                    <label class="form-check-label" for="focusSkills">Focus on developing both technical and soft skills</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="bsitAdvice" id="otherAdvice" value="Other" @if(isset($survey) && !in_array($survey->q37, [
                                ...
                                <input type="text" id="otherAdviceInput" name="bsitAdviceOther" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q37, [
                                    'Be proactive in seeking internships and real-world experience',
                                    'Build a strong network with professors and industry professionals',
                                    'Stay updated with the latest industry trends and technologies',
                                    'Focus on developing both technical and soft skills'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparationWish" id="networkingImportance" value="The importance of networking and building professional relationships" @if(isset($survey) && $survey->q38 == 'The importance of networking and building professional relationships') checked @endif required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparationWish" id="jobSearchProcess" value="How to handle the job search process more effectively" @if(isset($survey) && $survey->q38 == 'How to handle the job search process more effectively') checked @endif>
                                    <label class="form-check-label" for="jobSearchProcess">How to handle the job search process more effectively</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparationWish" id="internshipExperience" value="The significance of gaining work experience through internships" @if(isset($survey) && $survey->q38 == 'The significance of gaining work experience through internships') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparationWish" id="careerExpectations" value="How to manage career expectations and growth" @if(isset($survey) && $survey->q38 == 'How to manage career expectations and growth') checked @endif>
                                    <label class="form-check-label" for="careerExpectations">How to manage career expectations and growth</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="preparationWish" id="otherPreparationWish" value="Other" @if(isset($survey) && !in_array($survey->q38, [
                                ...
                                <input type="text" id="otherPreparationWishInput" name="preparationWishOther" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q38, [
                                    'The importance of networking and building professional relationships',
                                    'How to handle the job search process more effectively',
                                    'The significance of gaining work experience through internships',
                                    'How to manage career expectations and growth'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniProgramImprovement" id="careerEvents" value="By offering more career-oriented events and workshops" @if(isset($survey) && $survey->q39 == 'By offering more career-oriented events and workshops') checked @endif required>
                                    <label class="form-check-label" for="careerEvents">By offering more career-oriented events and workshops</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniProgramImprovement" id="jobBoards" value="Providing access to job boards and internship opportunities" @if(isset($survey) && $survey->q39 == 'Providing access to job boards and internship opportunities') checked @endif>
                                    <label class="form-check-label" for="jobBoards">Providing access to job boards and internship opportunities</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniProgramImprovement" id="certificationPrograms" value="Offering ongoing education or certification programs" @if(isset($survey) && $survey->q39 == 'Offering ongoing education or certification programs') checked @endif>
                                    <label class="form-check-label" for="certificationPrograms">Offering ongoing education or certification programs</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniProgramImprovement" id="alumniForum" value="Providing a forum for alumni to connect and collaborate" @if(isset($survey) && $survey->q39 == 'Providing a forum for alumni to connect and collaborate') checked @endif>
                                    <label class="form-check-label" for="alumniForum">Providing a forum for alumni to connect and collaborate</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alumniProgramImprovement" id="otherAlumniProgram" value="Other" @if(isset($survey) && !in_array($survey->q39, [
                                ...
                                <input type="text" id="otherAlumniProgramInput" name="alumniProgramOther" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q39, [
                                    'By offering more career-oriented events and workshops',
                                    'Providing access to job boards and internship opportunities',
                                    'Offering ongoing education or certification programs',
                                    'Providing a forum for alumni to connect and collaborate'
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="feedbackImprovement" id="techIntegration" value="Improve the integration of technology in the classroom" @if(isset($survey) && $survey->q40 == 'Improve the integration of technology in the classroom') checked @endif required>
                                    <label class="form-check-label" for="techIntegration">Improve the integration of technology in the classroom</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="feedbackImprovement" id="practicalTraining" value="Offer more practical and industry-oriented training" @if(isset($survey) && $survey->q40 == 'Offer more practical and industry-oriented training') checked @endif>
                                    <label class="form-check-label" for="practicalTraining">Offer more practical and industry-oriented training</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="feedbackImprovement" id="strongerAlumniNetwork" value="Create a stronger alumni network for mentorship and career growth" @if(isset($survey) && $survey->q40 == 'Create a stronger alumni network for mentorship and career growth') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="feedbackImprovement" id="closerTies" value="Foster closer ties between current students and alumni for better knowledge transfer" @if(isset($survey) && $survey->q40 == 'Foster closer ties between current students and alumni for better knowledge transfer') checked @endif>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="feedbackImprovement" id="otherFeedback" value="Other" @if(isset($survey) && !in_array($survey->q40, [
                                ...
                                <input type="text" id="otherFeedbackInput" name="feedbackOther" placeholder="Please specify" style="display:{{ isset($survey) && !in_array($survey->q40, [
                                    'Improve the integration of technology in the classroom',
                                    'Offer more practical and industry-oriented training',
                                    'Create a stronger alumni network for mentorship and career growth',
                                    'Foster closer ties between current students and alumni for better knowledge transfer'
                ...
                <input type="submit" class = "btn btn-primary" value = "ᯓ➤ Update Information" style = "margin: 10px;">
            </form>
              </div>
         </div>
