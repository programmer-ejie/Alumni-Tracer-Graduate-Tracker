...
//]]></script>
  ...
  <header id="home">
    ...
    <nav class="navbar navbar-expand-md navbar-dark top-nav-collapse default">
      <div class="container">
        <a class="navbar-brand" href="{{route('home')}}" style = "text-align: center; display: flex;">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <h1 class="mt-sm-3 text-white mb-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">Track and Connect with 
          <span class="text-primary">Alumni</span> Effortlessly
        </h1>
        <h5 class="mb-4 text-white opacity-75 wow fadeInUp" data-wow-delay="0.4s">
          Alumni Tracer is a powerful platform designed to help institutions maintain lifelong connections with graduates.
        </h5>
        <div class="my-5 wow fadeInUp" data-wow-delay="0.6s">
          <a href="{{route('alumni')}}" class="btn btn-outline-primary me-2">Alumni? Click Here!</a>
          <a href="{{route('login')}}" class="btn btn-primary" >
            <i class="ti ti-user-search me-1"></i>Get Started
          </a>
        </div>
        </div>
      </div>
